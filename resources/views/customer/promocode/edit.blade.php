    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0">Edit promocode</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
                    ...
                    <div class="col-12">
                        ...
                        <form action="{{route('customer.promocode.update')}}" method="POST" class="w-25">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" value="{{$promocode->promocode}}" name="promocode" class="form-control" required >
                                @error('promocode')
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="number" value="{{$promocode->price}}"  step="0.01" name="price" required>
                                @error('price')
                                <div class="text-danger">{{ $message }}</div>
                                @enderror
                            </div>
