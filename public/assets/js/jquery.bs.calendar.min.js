(function($) {
    ...
    function drawNoEvent(date) {
        ...
        <h6 class="mb-4 text-center">${currentNoAppointmentTranslate}</h6>
        </div>
        `
    }
    ...
    function drawTemplate(container) {
        ...
        container.html(`
			${todayHeader}
            <div class="d-block flex-nowrap justify-content-between align-items-center ">
                <a href="#" class="btn btn-link text-decoration-none  mx-1 flex-fill btn-curr-month month-name"></a>
                <a href="#" class="btn btn-link text-decoration-none btn-next-month pull-right"><i class="${settings.icons.next}"></i></a>
                <a href="#" class="btn btn-link text-decoration-none btn-prev-month pull-right"><i class="${settings.icons.prev}"></i></a>
            </div>
        ...
        Date.getDayNames(true).forEach(wd => {
            ...
            $("<div>", {
                html: wd,
                class: "col js-day-name-short text-center bootstrap-calendar-weekday" + addClass,
                css: cellCss
            })
    ...
    $.fn.bsCalendar = function(options, params = null) {
        ...
        function drawCalendar(containerElement, selectedDate = null) {
            ...
            calendar.forEach(week => {
                ...
                $("<div>", {
                    class: "d-flex d-none justify-content-center align-items-center js-cal-row bootstrap-calendar-week",
                    css: {
                ...
                week.days.forEach(day => {
                    ...
                    const cellBackground = isToday ? "  " : isInMonth ? " fw-bold " : " fw-small ";
                    ...
                    let col = $("<div>", {
                        ...
                        html: ['<div style="font-size:' + "16" + 'px">' + day.formatDate(true)[2] + "</div>", ['<small class="js-count-events position-absolute text-center rounded-circle" style="width:4px; height:4px; bottom:4px; left: 50%; margin-left:-2px">', "</small>"].join("")].join("")
                    }).appendTo(weekContainer);
                ...
                if (widthHeight >= 35) {
                    $(containerElement).find("[data-date]").each(function(i, e) {
                        ...
                        if (count) {
                            ...
                            $(e).find(".js-count-events").closest('.bootstrap-calendar-day').addClass('has-events');
                            console.log(count)
                        }
                    })
                }
                if (foundToday) {
                    $(containerElement).find(".js-today").trigger("click", [true])
                }
            })
        }
        ...
        function events(containerElement) {
            ...
            containerElement.on("click", ".js-event", function(e) {
            ...
            if (!events.length) {
                ...
                events.forEach(event => {
                    ...
                    let eventWrapper = $("<div>", {
                        class: "js-event col-6 col-sm-3 d-flex justify-content-between align-items-center myDisp",
                        html: `<div class="flex-fill text-center">${eventHtml}</div><div><div class="btn-group-vertical btn-group-sm" role="group"></div></div>`
                    }).appendTo(eventList);
